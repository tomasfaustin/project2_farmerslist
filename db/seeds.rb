...
if Post.destroy_all && User.destroy_all
  ...
  posts = Post.create([
    ...
    { user: bob, title: "Grass-Fed Beef from Eel River Valley", message: "1/4, 1/2, or whole animals available. Call Doug for details at 555-4444", organic: true, location: "Worldwide shipping available" }
    ])
end
